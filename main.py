...
def main() -> None:
    ...
    if not steamid:
        ...
        if steamid:
            ...
            log.warning("Could not detect SteamID. Pass --steamid manually for player-filtered highlights.")
    ...
    if not demo_dir_str:
        ...
        if detected:
            ...
            # Dev fallback: watch ./demos relative to project root
    ...
    watch(demo_dir=demo_dir, steamid=steamid)
